...
<body id="page-top">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value='/admin/home.htm'/>"> <i
					class="fas fa-fw fa-wrench"></i> <span>Dashboard</span>
			</a></li>

			<li class="nav-item active"><a class="nav-link"
				href="<c:url value='/admin/products.htm'/>"> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>Products</span>
			</a></li>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">${user.name}</span> <img class="img-profile rounded-circle"
								src="${user.avatar}">
								...
								<c:forEach var="p" items="${products}" varStatus="status">
									<tr>
										...
										<td>
											...
											<img style="width:80px;height:120px;object-fit:cover;" src="${p.images.get(0).imageURL}"/> 
											</div>							
										</td>
										<td>${p.name}</td>
										...
										<td>
										<a href="<c:url value="/product/delete/${p.id}.htm"/>">
	...
	<script src="resources/libs/admin_global_script.js"></script>
