					...
					<div class="footer-widget mb-40">
						...
						<div class="footer-newsletter">
							...
							<div id="mc_embed_signup" class="subscribe-form pr-40">
								<form class="validate" target="_blank">
									<div id="mc_embed_signup_scroll"
										class="mc-form d-flex justify-center align-items-center">
							...
							<div class="footer-contact">
								...
								<p>
									<span><i class="ti-headphone-alt"></i></span> +88 (015) 609735
									or +88 (012) 112266
								</p>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="copyright">
						<p>
							Copyright © <a class="author" target="_blank" href="https://github.com/VOHIEUTHANG">devostack2k</a> 2022 . All
							Right Reserved.
						</p>
					</div>
				</div>
